...
export const metadata = {
	...
	description:
		"Explore holiday packages and travel experiences from Quantum Travels.",
};

export const revalidate = 300;

export default async function PackageHolidayPage() {
	const holidays = await getTourPackages("holiday");
