...
const branchContacts = [
  ...
  {
    label: "Ikeja",
    address: "Suite 1-04, Centage Plaza 14 Allen Avenue",
    phones: ["+234 701 412 2465"],
  },
  {
    label: "Abuja",
...
const faqs = [
  {
    ...
    answer:
      "Yes. We provide end-to-end corporate travel management, including flight bookings, accommodation, and expense reporting tailored to your business needs.",
  },
  {
    question: "Can you help plan vacation or holiday trips?",
    answer:
      "Yes. Our team can help with holiday packages, flights, accommodation, tours, and travel support for individual, family, and group trips.",
  },
  {
    question: "Do you offer guided tours?",
    answer:
      "Yes. We arrange guided experiences for selected destinations and can recommend tour options based on your itinerary.",
  },
  {
    question: "Do you provide airport pickup and drop-off services?",
    answer:
      "Yes. Airport transfer services are available for pickup, drop-off, and car hire requests.",
  },
  {
    question: "Do you assist with visa applications?",
    answer:
      "Yes. We provide visa advisory and processing support for eligible destinations.",
  },
  {
    question: "How do I make a booking?",
    answer:
      "You can start with the relevant service page, send an enquiry, or contact our team directly for guided booking support.",
  },
  {
    question: "What payment methods do you accept?",
    answer:
      "Our team will confirm available payment options when your booking or enquiry is reviewed.",
  },
  {
    question: "Can you manage travel for large groups or corporate events?",
    answer:
      "Yes. We support large group travel, MICE requests, and corporate event logistics.",
  },
] as const;
          ...
          return (
            ...
            >
              <button
                ...
                className="flex w-full items-center justify-between gap-4 px-5 py-3 text-left text-sm font-medium text-text transition-colors hover:bg-black/[0.02] md:px-6 md:text-base"
              >
                <span>{faq.question}</span>
                {isOpen ? (
                  <Minus className="size-4 shrink-0 text-[#9e328a]" />
                ) : (
                  <Plus className="size-4 shrink-0 text-[#9e328a]" />
                )}
              </button>

              {isOpen ? (
                <div className="px-5 pb-4 text-xs leading-[1.5] font-light text-text md:px-6 md:text-base">
                  {faq.answer}
                </div>
              ) : null}
            </div>
